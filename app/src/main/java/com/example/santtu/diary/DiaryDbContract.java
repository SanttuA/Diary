...
/**
 * The formal declaration how the database is organized.
 */

public final class DiaryDbContract {

    //private restriction to prevent accidental instantiating.
    ...
    //subclass that handles accessing the database
